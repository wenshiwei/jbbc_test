...
<script type="text/javascript">
	...
	function upPageCheck(nowpage,allpage) {
		if(1<nowpage){
			window.location.href="UpDatePagesServlet?NowPage="+(nowpage-1)+"&Status="+4;
		}
		else{
		alert("当前为第一页，没有上一页！");	
		}
...
<body>
	<div>
		...
		<div style="margin-top: 15px;">
			<form action="FactoryStaThreeServlet" method="post">
				<div
				...
				<div
					...
					<input type="button" value="上一页" style="margin-top: 20px;"
						...
						<input value="当前第${nowPages }页/ 共${allPages }页" disabled="disabled" /> 
						<input type="button" value="下一页" onclick="belowPageCheck(${nowPages },${allPages })" /> 
