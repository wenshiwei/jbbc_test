...
<script type="text/javascript">
	...
	function upPageCheck(nowpage,allpage) {
		if(1<nowpage){
			window.location.href="UpDatePagesServlet?NowPage="+(nowpage-1)+"&Status="+2;
		}
		else{
		alert("当前为第一页，没有上一页！");	
		}
...
<body>
	<div>
		...
		<div style="margin-top: 15px;">
			<form action="FdOrStaTwoServlet" method="post">
				<div
					...
					<fieldset
						...
						<ul>
							...
							<li><a href="OpenOrderPagServlet?Status=1"><span>未处理 </span></a></li>
					...
					<fieldset
						...
						<table style="width: 100%; border: 0px;">
							<tr align="center">
								...
								<th style="width: 20%; height: 25px; border: 2px solid;"><span>客户ID</span></th>
								<th style="width: 20%; height: 25px; border: 2px solid;"><span>客户地址</span></th>
							</tr>
							<c:forEach items="${facadesimpojo }" var="facadOrdeDate">
								<tr align="center">
									<th style="width: 20%; height: 30px; border: 1px solid;"><input
										...
										value="${facadOrdeDate.getOrderId() }" /><span></span></th>
