...
<body onload="send()">
	...
	<div id="u1" class="ax_image">
		<img id="u1_img" class="img " src="images/index_jsp/six.jpg"/>
	</div>
	...
	<form action="IndexServlet" method="post">
      ...
      <div id="u8" class="ax_text_field">
        <input id="u8_input" type="text" value="" name="username"/>
      </div>
      ...
      <div id="u11" class="ax_text_field">
        <input id="u11_input" type="password" name="password"/>
      </div>
      ...
      <div id="u15" class="ax_paragraph">
        ...
        <div id="u16" class="text">
          <a href="regist_jsp.jsp" style="text-decoration: none;"><font color="blue">注册</font></a>
        </div>
      </div>
	</form>
      ...
      <div id="u105" class="ax_h2">
        ...
        <div id="u106" class="text">
          <a href="NoticeServlet" style="text-decoration: none;">优惠</a>
      ...
      <div id="u109" class="ax_h2">
        ...
        <div id="u110" class="text">
          <p><a href="IndexServlet" style="text-decoration: none;">个人用户</a></p>
        </div>
      </div>
      ...
      <div id="u145" class="ax_shape">
        <img id="u145_img" class="img " src="images/index_jsp/u145.png"/>
        <!-- Unnamed () -->
