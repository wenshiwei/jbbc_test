...
<body>
	<div>
			...
			<div
				...
				<fieldset style="width: 100%; height: 93%; border: 1px solid black;">
					...
					<ul>
						...
						<li><a href="FacadeServlet?Status=1"><span>未处理 </span></a></li>
						<li><a href="FdeOrderDealServlet?Status=2"><span>已处理</span></a></li>
						<li><a href="FdeOrderSendServlet?Status=3"><span>订单派送处理</span></a></li>
					</ul>
				...
				<fieldset style="width: 100%; height: 93%; border: 1px solid black;">
					<table border="" style="width: 100%; border: 0px;">
						...
						<c:forEach items="${lista }" var="lista">
							<tr align="center">
								<th style="width: 20%; height: 30px; border: 1px solid;"><span>${lista.orderId}</span></th>
								<th style="width: 20%; height: 30px; border: 1px solid;"><span>${customerId }</span></th>
								<th style="width: 20%; height: 30px; border: 1px solid;"><span>${detail}</span></th>
							</tr>
						</c:forEach>
					</table>
				</fieldset>
		...
		<div style="float: left; width: 85%; margin-left: 60px;"align="center">
