...
<head>
 <title>company.jsp</title>
    ...
    <link href="files/company_jsp/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/company_jsp/data.js"></script>
...
<body>
	<div id="base" class="">
      ...
      <div id="u2" class="ax_shape">
        <img id="u2_img" class="img " src="images/person_jsp/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u6" class="ax_shape">
        <img id="u6_img" class="img " src="images/person_jsp/u6.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u16" class="ax_shape">
        <img id="u16_img" class="img " src="images/person_jsp/u16.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u18" class="ax_paragraph">
        ...
        <div id="u19" class="text">
          <a href="BouoCustServlet?username=${loginId}" style="text-decoration: none;">
          <font color="blue">处理中的订单</font></a>
        </div>
      </div>
      ...
      <div id="u24" class="ax_paragraph">
        ...
        <div id="u25" class="text">
          <a href="#" style="text-decoration: none;"><font color="blue">新增订单</font></a>
        </div>
      </div>

		<form action="CompanyFactoryServlet?username1=${loginId}" method="post">
			<!-- Unnamed (Shape) -->
      <div id="u29" class="ax_paragraph">
        <img id="u29_img" class="img " src="resources/images/transparent.gif"/>
        <!-- Unnamed () -->
        <div id="u30" class="text">
          <p><span>衣物送达地址</span></p>
        </div>
      </div>

      <!-- Unnamed (Droplist) -->
      <div id="u31" class="ax_droplist">
        <input id="u31_input" value="${detail}"/>
      </div>
      ...
      <div id="u37" class="ax_text_field">
        <input id="u37_input" type="text" name="message"/>
      </div>

      <!-- Unnamed (HTML Button) -->
      <div id="u38" class="ax_html_button">
        <input id="u38_input" type="submit" value="确认提交"/>
      </div>
		</form>
      ...
      <div id="u39" class="ax_shape">
        <img id="u39_img" class="img " src="images/index_jsp/u101.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u43" class="ax_h2">
        ...
        <div id="u44" class="text">
          <a href="NoticeServlet?username=${companyId}" style="text-decoration: none;">优惠</a>
        </div>
      </div>
      ...
      <div id="u47" class="ax_h2">
        ...
        <div id="u48" class="text">
          <a href="PersonServlet?username=${companyId }" style="text-decoration: none;">个人用户</a>
        </div>
      </div>
